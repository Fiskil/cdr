...
// Defines values for BankingProductConstraintV2ConstraintType.
const (
	MAXBALANCE     BankingProductConstraintV2ConstraintType = "MAX_BALANCE"
	MAXLIMIT       BankingProductConstraintV2ConstraintType = "MAX_LIMIT"
	MAXLVR         BankingProductConstraintV2ConstraintType = "MAX_LVR"
	MINBALANCE     BankingProductConstraintV2ConstraintType = "MIN_BALANCE"
	MINLIMIT       BankingProductConstraintV2ConstraintType = "MIN_LIMIT"
	MINLVR         BankingProductConstraintV2ConstraintType = "MIN_LVR"
	OPENINGBALANCE BankingProductConstraintV2ConstraintType = "OPENING_BALANCE"
)
...
const (
	BankingTransactionDetailV2TypeDIRECTDEBIT      BankingTransactionDetailV2Type = "DIRECT_DEBIT"
	BankingTransactionDetailV2TypeFEE              BankingTransactionDetailV2Type = "FEE"
	BankingTransactionDetailV2TypeINTERESTCHARGED  BankingTransactionDetailV2Type = "INTEREST_CHARGED"
	BankingTransactionDetailV2TypeINTERESTPAID     BankingTransactionDetailV2Type = "INTEREST_PAID"
	BankingTransactionDetailV2TypeOTHER            BankingTransactionDetailV2Type = "OTHER"
	BankingTransactionDetailV2TypePAYMENT          BankingTransactionDetailV2Type = "PAYMENT"
	BankingTransactionDetailV2TypeTRANSFERINCOMING BankingTransactionDetailV2Type = "TRANSFER_INCOMING"
	BankingTransactionDetailV2TypeTRANSFEROUTGOING BankingTransactionDetailV2Type = "TRANSFER_OUTGOING"
)
...
// BankingProductConstraintV2 defines model for BankingProductConstraintV2.
type BankingProductConstraintV2 struct {
	// AdditionalInfo Display text providing more information on the constraint.
	AdditionalInfo *string `json:"additionalInfo,omitempty"`
	...
	ConstraintType BankingProductConstraintV2ConstraintType `json:"constraintType"`
}

// BankingProductConstraintV2ConstraintType The type of constraint described. For further details, refer to [Product Constraint Types](#tocSproductconstrainttypedoc).
type BankingProductConstraintV2ConstraintType string
...
// BankingProductDetailV5 defines model for BankingProductDetailV5.
type BankingProductDetailV5 struct {
	...
	Constraints *[]BankingProductConstraintV2 `json:"constraints,omitempty"`
...
// BankingProductDetailV5AllOf defines model for BankingProductDetailV5_allOf.
type BankingProductDetailV5AllOf struct {
	// Bundles An array of bundles that this product participates in. Each bundle is described by free form information but also by a list of product IDs of the other products that are included in the bundle. It is assumed that the current product is included in the bundle also.
	Bundles *[]BankingProductBundle `json:"bundles,omitempty"`
...
type BankingScheduledPaymentFrom struct {
	// AccountId _accountId_ of the account that is the source of funds for the payment.
	AccountId string `json:"accountId"`
}
...
type RequestAccountIdsData struct {
	// AccountIds Array of _accountId_ values.
...
// ResponseBankingProductByIdV5 defines model for ResponseBankingProductByIdV5.
type ResponseBankingProductByIdV5 struct {
	Data  BankingProductDetailV5 `json:"data"`
	Links Links                  `json:"links"`
	Meta  *Meta                  `json:"meta,omitempty"`
}
