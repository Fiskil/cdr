...
type ResponseBankingScheduledPaymentsList struct {
	Data  ResponseBankingScheduledPaymentsListData `json:"data"`
	Links LinksPaginated                           `json:"links"`
	Meta  MetaPaginated                            `json:"meta"`
}

// ResponseBankingScheduledPaymentsListData defines model for ResponseBankingScheduledPaymentsList_data.
