...
// Defines values for EnergyServicePointDetailV2AllOfRelatedParticipantsRole.
const (
	DRSP EnergyServicePointDetailV2AllOfRelatedParticipantsRole = "DRSP"
	FRMP EnergyServicePointDetailV2AllOfRelatedParticipantsRole = "FRMP"
	LNSP EnergyServicePointDetailV2AllOfRelatedParticipantsRole = "LNSP"
)

// Defines values for EnergyServicePointDetailV2AllOfSpecificationsInstallationType.
const (
	BASIC    EnergyServicePointDetailV2AllOfSpecificationsInstallationType = "BASIC"
	COMMS1   EnergyServicePointDetailV2AllOfSpecificationsInstallationType = "COMMS1"
	COMMS2   EnergyServicePointDetailV2AllOfSpecificationsInstallationType = "COMMS2"
	COMMS3   EnergyServicePointDetailV2AllOfSpecificationsInstallationType = "COMMS3"
	COMMS4   EnergyServicePointDetailV2AllOfSpecificationsInstallationType = "COMMS4"
	COMMS4C  EnergyServicePointDetailV2AllOfSpecificationsInstallationType = "COMMS4C"
	COMMS4D  EnergyServicePointDetailV2AllOfSpecificationsInstallationType = "COMMS4D"
	MRAM     EnergyServicePointDetailV2AllOfSpecificationsInstallationType = "MRAM"
	MRIM     EnergyServicePointDetailV2AllOfSpecificationsInstallationType = "MRIM"
	NCOLNUML EnergyServicePointDetailV2AllOfSpecificationsInstallationType = "NCOLNUML"
	PROF     EnergyServicePointDetailV2AllOfSpecificationsInstallationType = "PROF"
	SAMPLE   EnergyServicePointDetailV2AllOfSpecificationsInstallationType = "SAMPLE"
	UMCP     EnergyServicePointDetailV2AllOfSpecificationsInstallationType = "UMCP"
	VICAMI   EnergyServicePointDetailV2AllOfSpecificationsInstallationType = "VICAMI"
)
...
// Defines values for EnergyServicePointV2ConsumerProfileClassification.
const (
	BUSINESS    EnergyServicePointV2ConsumerProfileClassification = "BUSINESS"
	RESIDENTIAL EnergyServicePointV2ConsumerProfileClassification = "RESIDENTIAL"
)

// Defines values for EnergyServicePointV2ConsumerProfileThreshold.
const (
	HIGH   EnergyServicePointV2ConsumerProfileThreshold = "HIGH"
	LOW    EnergyServicePointV2ConsumerProfileThreshold = "LOW"
	MEDIUM EnergyServicePointV2ConsumerProfileThreshold = "MEDIUM"
)
...
// Defines values for GetElectricityServicePointUsageParamsIntervalReads.
const (
	FULL  GetElectricityServicePointUsageParamsIntervalReads = "FULL"
	MIN30 GetElectricityServicePointUsageParamsIntervalReads = "MIN_30"
	NONE  GetElectricityServicePointUsageParamsIntervalReads = "NONE"
)
...
type EnergyAccountBaseV2 struct {
	...
	AccountId EnergyAccountId `json:"accountId"`

	// AccountNumber Optional identifier of the account as defined by the data holder. This must be the value presented on physical statements (if it exists) and must not be used for the value of _accountId_.
	AccountNumber *string `json:"accountNumber,omitempty"`

	// CreationDate The date that the account was created or opened. Mandatory if _openStatus_ is `OPEN`.
...
type EnergyAccountDetailV4AllOfAuthorisedContacts struct {
	// FirstName For people with single names this field need not be present. The single name should be in the _lastName_ field.
...
type EnergyAccountDetailV4AllOfPlanDetail struct {
	// ElectricityContract The details of the terms for the supply of electricity under this plan. Is mandatory if _fuelType_ is set to `ELECTRICITY` or `DUAL`.
	...
	// GasContract The details of the terms for the supply of electricity under this plan. Is mandatory if _fuelType_ is set to `GAS` or `DUAL`.
	GasContract *EnergyPlanContractV3 `json:"gasContract,omitempty"`

	// IsContingentPlan Flag that indicates that the plan is contingent on the customer taking up an alternate fuel plan from the same retailer (for instance, if the _fuelType_ is `ELECTRICITY` then a `GAS` plan from the same retailer must be taken up). Has no meaning if the plan has a _fuelType_ of `DUAL`. If absent the value is assumed to be `false`.
...
type EnergyAccountDetailV4AllOfPlans struct {
	...
	// PlanDetail Detail on the plan applicable to this account. Mandatory if _openStatus_ is `OPEN`.
	PlanDetail *EnergyAccountDetailV4AllOfPlanDetail `json:"planDetail,omitempty"`

	// PlanOverview Mandatory if _openStatus_ is `OPEN`.
	PlanOverview *EnergyAccountV2AllOfPlanOverview `json:"planOverview,omitempty"`

	// ServicePointIds An array of _servicePointId_ values, representing NMIs, that this account is linked to.
...
type EnergyAccountV2AllOfPlans struct {
	...
	// ServicePointIds An array of _servicePointId_ values, representing NMIs, that this plan is linked to. If there are no service points allocated to this plan then an empty array would be expected.
	ServicePointIds []EnergyServicePointId `json:"servicePointIds"`
}
...
type EnergyBillingDemandTransactionV3 struct {
	...
	// Rate The rate for the demand charge in _measureUnit_. Assumed to be `KVA` if _measureUnit_ not provided. A negative value indicates power generated.
	Rate float32 `json:"rate"`

	// ServicePointId Unique identifier for the service point.
	ServicePointId *EnergyServicePointId `json:"servicePointId,omitempty"`
...
type EnergyBillingTransactionV3 struct {
	...
	// Demand Represents a demand charge or generation credit. Mandatory if _transactionUType_ is equal to `demand`.
	...
	// Gst The GST incurred in the transaction. Should not be included for credits or payments. If absent then zero is assumed.
	Gst *string `json:"gst,omitempty"`

	// OnceOff Represents a once off charge or credit. Mandatory if _transactionUType_ is equal to `onceOff`.
	OnceOff *EnergyBillingOnceOffTransaction `json:"onceOff,omitempty"`

	// OtherCharges Represents charge other than usage and once off. Mandatory if _transactionUType_ is equal to `otherCharges`.
	OtherCharges *EnergyBillingOtherTransaction `json:"otherCharges,omitempty"`

	// Payment Represents a payment to the account. Mandatory if _transactionUType_ is equal to `payment`.
	...
	// Usage Represents a usage charge or generation credit. Mandatory if _transactionUType_ is equal to `usage`.
...
type EnergyConcession struct {
	// AdditionalInfo Display text providing more information on the concession. Mandatory if _type_ is `VARIABLE`.
	...
	// AppliedTo Array of ENUMs to specify what the concession applies to. Multiple ENUM values can be provided. If absent, `USAGE` is assumed.
...
type EnergyDerRecord struct {
	...
	// ApprovedCapacity Approved small generating unit capacity as agreed with NSP in the connection agreement, expressed in kVA. Value of `0` indicates no DER record exists for the given _servicePointId_.
	ApprovedCapacity float32 `json:"approvedCapacity"`

	// AvailablePhasesCount The number of phases available for the installation of DER. Acceptable values are `0`, `1`, `2` or `3`. Value of `0` indicates no DER record exists for the given _servicePointId_.
	...
	// InstalledPhasesCount The number of phases that DER is connected to. Acceptable values are `0`, `1`, `2` or `3`. Value of `0` indicates no DER record exists for the given _servicePointId_.
	...
	// ProtectionMode Required only when the _hasCentralProtectionControl_ flag is set to `true`. One or more of the object fields will be provided to describe the protection modes in place.
...
type EnergyDerRecordAcConnections struct {
	...
	// InverterDeviceCapacity The rated AC output power that is listed in the product specified by the manufacturer. Mandatory if _equipmentType_ is `INVERTER`. Default is `0` if value not known.
	InverterDeviceCapacity *float32 `json:"inverterDeviceCapacity,omitempty"`

	// InverterModelNumber The inverter model number. Mandatory if _equipmentType_ is `INVERTER`.
	InverterModelNumber *string `json:"inverterModelNumber,omitempty"`

	// InverterSeries The inverter series. Mandatory if _equipmentType_ is `INVERTER`.
	InverterSeries *string `json:"inverterSeries,omitempty"`

	// ManufacturerName The name of the inverter manufacturer. Mandatory if _equipmentType_ is `INVERTER`.
...
type EnergyInvoice struct {
	...
	// Electricity Object containing charges and credits related to electricity usage.
	Electricity *EnergyInvoiceElectricityUsageCharges `json:"electricity,omitempty"`

	// Gas Object containing charges and credits related to gas usage.
...
type EnergyPaymentSchedule struct {
	...
	// CardDebit Represents a regular credit card payment schedule. Mandatory if _paymentScheduleUType_ is set to `cardDebit`.
	CardDebit *EnergyPaymentScheduleCardDebit `json:"cardDebit,omitempty"`

	// DigitalWallet Represents a regular payment from a digital wallet. Mandatory if _paymentScheduleUType_ is set to `digitalWallet`.
	DigitalWallet *EnergyPaymentScheduleDigitalWallet `json:"digitalWallet,omitempty"`

	// DirectDebit Represents a regular direct debit from a specified bank account. Mandatory if _paymentScheduleUType_ is set to `directDebit`.
	DirectDebit *EnergyPaymentScheduleDirectDebit `json:"directDebit,omitempty"`

	// ManualPayment Represents a manual payment schedule where the customer pays in response to a delivered statement. Mandatory if _paymentScheduleUType_ is set to `manualPayment`.
...
type EnergyPaymentScheduleResponseData struct {
	// PaymentSchedules Array may be empty if no payment schedules exist.
...
type EnergyPaymentScheduleDirectDebit struct {
	// AccountNumber The unmasked account number for the account to be debited. Is expected to be formatted as digits only with leading zeros included and no punctuation or spaces. Is required if _isTokenised_ is absent or `false`.
	AccountNumber *string `json:"accountNumber,omitempty"`

	// Bsb The unmasked BSB for the account to be debited. Is expected to be formatted as digits only with leading zeros included and no punctuation or spaces. Is required if _isTokenised_ is absent or `false`.
...
type EnergyPlan struct {
	...
	// EffectiveFrom The date and time from which this plan is effective (i.e. is available for origination). Used to enable the articulation of products to the regime before they are available for customers to originate.
	...
	// PlanId The unique identifier for the Energy plan.
	PlanId EnergyPlanId `json:"planId"`
...
type EnergyPlanContractFullV3 struct {
	...
	// BenefitPeriod Description of the benefit period. Should only be present if _termType_ has the value `ONGOING`.
	...
	// TariffPeriod Array of tariffs that apply to periods throughout the year.
	...
	// TimeZone Required if _pricingModel_ is set to `TIME_OF_USE`. Defines the time zone to use for calculation of the time of use thresholds. Defaults to `AEST` if absent.
	TimeZone *EnergyPlanContractFullV3TimeZone `json:"timeZone,omitempty"`

	// Variation Free text description of price variation policy and conditions for the contract. Mandatory if _isFixed_ is `false`.
...
// EnergyPlanContractFullV3TimeZone Required if _pricingModel_ is set to `TIME_OF_USE`. Defines the time zone to use for calculation of the time of use thresholds. Defaults to `AEST` if absent.
...
// EnergyPlanContractV3TimeZone Required if _pricingModel_ is set to `TIME_OF_USE`. Defines the time zone to use for calculation of the time of use thresholds. Defaults to `AEST` if absent.
...
// EnergyPlanControlledLoadV2 defines model for EnergyPlanControlledLoadV2.
type EnergyPlanControlledLoadV2 struct {
	...
	// RateBlockUType Specifies the type of controlled load rate.
	RateBlockUType EnergyPlanControlledLoadV2RateBlockUType `json:"rateBlockUType"`

	// SingleRate Object representing a single controlled load rate. Required if _rateBlockUType_ is `singleRate`.
	SingleRate *EnergyPlanControlledLoadV2SingleRate `json:"singleRate,omitempty"`

	// StartDate Optional start date of the application of the controlled load rate.
	StartDate *string `json:"startDate,omitempty"`

	// TimeOfUseRates Array of objects representing time of use rates. Required if _rateBlockUType_ is `timeOfUseRates`.
	TimeOfUseRates *[]EnergyPlanControlledLoadV2TimeOfUseRates `json:"timeOfUseRates,omitempty"`
}

// EnergyPlanControlledLoadV2RateBlockUType Specifies the type of controlled load rate.
type EnergyPlanControlledLoadV2RateBlockUType string

// EnergyPlanControlledLoadV2SingleRate Object representing a single controlled load rate. Required if _rateBlockUType_ is `singleRate`.
type EnergyPlanControlledLoadV2SingleRate struct {
	...
	Rates []EnergyPlanControlledLoadV2SingleRateRates `json:"rates"`
}

// EnergyPlanControlledLoadV2SingleRateRates defines model for EnergyPlanControlledLoadV2_singleRate_rates.
type EnergyPlanControlledLoadV2SingleRateRates struct {
	// MeasureUnit The measurement unit of rate. Assumed to be `KWH` if absent.
	MeasureUnit *MeasureUnitEnum `json:"measureUnit,omitempty"`
...
// EnergyPlanControlledLoadV2TimeOfUse defines model for EnergyPlanControlledLoadV2_timeOfUse.
type EnergyPlanControlledLoadV2TimeOfUse struct {
	// AdditionalInfo Display text providing more information on the controlled load, for e.g., controlled load availability if specific day/time is not known. Required if _startTime_ and _endTime_ absent or if _additionalInfoUri_ provided.
	AdditionalInfo *string `json:"additionalInfo,omitempty"`

	// AdditionalInfoUri Optional link to additional information regarding the controlled load.
	AdditionalInfoUri *string `json:"additionalInfoUri,omitempty"`

	// Days The days that this time window applies to.
	Days *[]EnergyDaysEnum `json:"days,omitempty"`

	// EndTime The end of the time window per day for which the controlled load rate applies. Required if _startTime_ provided. Formatted according to [ISO 8601 Times](https://en.wikipedia.org/wiki/ISO_8601#Times). If the time is provided without a UTC offset, the time zone will be determined by the value of EnergyPlanContract.timeZone.
	EndTime *string `json:"endTime,omitempty"`

	// StartTime The beginning of the time window per day for which the controlled load rate applies. Required if _endTime_ provided. Formatted according to [ISO 8601 Times](https://en.wikipedia.org/wiki/ISO_8601#Times). If the time is provided without a UTC offset, the time zone will be determined by the value of EnergyPlanContract.timeZone.
	StartTime *string `json:"startTime,omitempty"`
}

// EnergyPlanControlledLoadV2TimeOfUseRates defines model for EnergyPlanControlledLoadV2_timeOfUseRates.
type EnergyPlanControlledLoadV2TimeOfUseRates struct {
	// DailySupplyCharge The daily supply charge (exclusive of GST) for this controlled load tier.
	DailySupplyCharge *string `json:"dailySupplyCharge,omitempty"`
	...
	// TimeOfUse Array of time windows for which this time of use rate applies.
	TimeOfUse []EnergyPlanControlledLoadV2TimeOfUse `json:"timeOfUse"`
...
// EnergyPlanDiscounts defines model for EnergyPlanDiscounts.
type EnergyPlanDiscounts struct {
	// Category The type of the discount. Mandatory if the discount _type_ is `CONDITIONAL`.
	...
	// FixedAmount Required if _methodUType_ is `fixedAmount`.
	FixedAmount *EnergyPlanDiscountsFixedAmount `json:"fixedAmount,omitempty"`

	// MethodUType The method of calculation of the discount.
	MethodUType EnergyPlanDiscountsMethodUType `json:"methodUType"`

	// PercentOfBill Required if _methodUType_ is `percentOfBill`.
	PercentOfBill *EnergyPlanDiscountsPercentOfBill `json:"percentOfBill,omitempty"`

	// PercentOfUse Required if _methodUType_ is `percentOfUse`.
	PercentOfUse *EnergyPlanDiscountsPercentOfUse `json:"percentOfUse,omitempty"`

	// PercentOverThreshold Required if _methodUType_ is `percentOverThreshold`.
	PercentOverThreshold *EnergyPlanDiscountsPercentOverThreshold `json:"percentOverThreshold,omitempty"`

	// Type The type of the discount.
	Type EnergyPlanDiscountsType `json:"type"`
}

// EnergyPlanDiscountsCategory The type of the discount. Mandatory if the discount _type_ is `CONDITIONAL`.
...
// EnergyPlanDiscountsFixedAmount Required if _methodUType_ is `fixedAmount`.
type EnergyPlanDiscountsFixedAmount struct {
	// Amount The amount of the discount.
	Amount string `json:"amount"`
}

// EnergyPlanDiscountsPercentOfBill Required if _methodUType_ is `percentOfBill`.
type EnergyPlanDiscountsPercentOfBill struct {
	// Rate The rate of the discount applied to the bill amount.
	Rate string `json:"rate"`
}

// EnergyPlanDiscountsPercentOfUse Required if _methodUType_ is `percentOfUse`.
type EnergyPlanDiscountsPercentOfUse struct {
	// Rate The rate of the discount applied to the _usageamount_.
	Rate string `json:"rate"`
}

// EnergyPlanDiscountsPercentOverThreshold Required if _methodUType_ is `percentOverThreshold`.
type EnergyPlanDiscountsPercentOverThreshold struct {
...
// EnergyPlanEligibility defines model for EnergyPlanEligibility.
type EnergyPlanEligibility struct {
	...
	// Type The type of the eligibility restriction.<br/>The `CONTINGENT_PLAN` value indicates that the plan is contingent on the customer taking up an alternate fuel plan from the same retailer (for instance, if the _fuelType_ is `ELECTRICITY` then a `GAS` plan from the same retailer must be taken up).
...
// EnergyPlanFees defines model for EnergyPlanFees.
type EnergyPlanFees struct {
	// Amount The fee amount. Required if _term_ is not `PERCENT_OF_BILL`.
	Amount *string `json:"amount,omitempty"`

	// Description A description of the fee.
	Description *string `json:"description,omitempty"`

	// Rate The fee rate. Required if _term_ is `PERCENT_OF_BILL`.
...
// EnergyPlanGreenPowerCharges defines model for EnergyPlanGreenPowerCharges.
type EnergyPlanGreenPowerCharges struct {
	...
	Tiers []EnergyPlanGreenPowerChargesTiers `json:"tiers"`
...
// EnergyPlanGreenPowerChargesTiers defines model for EnergyPlanGreenPowerCharges_tiers.
type EnergyPlanGreenPowerChargesTiers struct {
...
// EnergyPlanIncentives defines model for EnergyPlanIncentives.
...
// EnergyPlanSolarFeedInTariffV3 defines model for EnergyPlanSolarFeedInTariffV3.
type EnergyPlanSolarFeedInTariffV3 struct {
	...
	// SingleTariff Represents a constant tariff. Mandatory if _tariffUType_ is set to `singleTariff`.
	SingleTariff *EnergyPlanSolarFeedInTariffV3SingleTariff `json:"singleTariff,omitempty"`

	// StartDate The start date of the application of the feed in tariff.
	StartDate *string `json:"startDate,omitempty"`

	// TariffUType Reference to the applicable tariff structure.
	TariffUType EnergyPlanSolarFeedInTariffV3TariffUType `json:"tariffUType"`

	// TimeVaryingTariffs Represents a tariff based on time of day. Mandatory if _tariffUType_ is set to `timeVaryingTariffs`.
	TimeVaryingTariffs *[]EnergyPlanSolarFeedInTariffV3TimeVaryingTariffs `json:"timeVaryingTariffs,omitempty"`
}
...
// EnergyPlanSolarFeedInTariffV3TariffUType Reference to the applicable tariff structure.
type EnergyPlanSolarFeedInTariffV3TariffUType string

// EnergyPlanSolarFeedInTariffV3SingleTariff Represents a constant tariff. Mandatory if _tariffUType_ is set to `singleTariff`.
type EnergyPlanSolarFeedInTariffV3SingleTariff struct {
	// Period Usage period for which the block rate applies. Formatted according to [ISO 8601 Durations](https://en.wikipedia.org/wiki/ISO_8601#Durations) (excludes recurrence syntax). Defaults to `P1Y` if absent.
	Period *string `json:"period,omitempty"`

	// Rates Array of feed in rates.
	Rates []EnergyPlanSolarFeedInTariffV3SingleTariffRates `json:"rates"`
}

// EnergyPlanSolarFeedInTariffV3SingleTariffRates defines model for EnergyPlanSolarFeedInTariffV3_singleTariff_rates.
type EnergyPlanSolarFeedInTariffV3SingleTariffRates struct {
	// MeasureUnit The measurement unit of rate. Assumed to be `KWH` if absent.
	MeasureUnit *MeasureUnitEnum `json:"measureUnit,omitempty"`
...
// EnergyPlanSolarFeedInTariffV3TimeVariations defines model for EnergyPlanSolarFeedInTariffV3_timeVariations.
type EnergyPlanSolarFeedInTariffV3TimeVariations struct {
	// Days The days that this time window applies to. At least one entry required.
	Days []EnergyDaysEnum `json:"days"`

	// EndTime The end of the time window per day for which the tariff applies. If absent assumes end of day (i.e. one second before midnight). Formatted according to [ISO 8601 Times](https://en.wikipedia.org/wiki/ISO_8601#Times). If the time is provided without a UTC offset, the time zone will be determined by the value of EnergyPlanContract.timeZone.
	EndTime *string `json:"endTime,omitempty"`

	// StartTime The beginning of the time window per day for which the tariff applies. If absent assumes start of day (i.e. midnight). Formatted according to [ISO 8601 Times](https://en.wikipedia.org/wiki/ISO_8601#Times). If the time is provided without a UTC offset, the time zone will be determined by the value of EnergyPlanContract.timeZone.
	StartTime *string `json:"startTime,omitempty"`
}

// EnergyPlanSolarFeedInTariffV3TimeVaryingTariffs defines model for EnergyPlanSolarFeedInTariffV3_timeVaryingTariffs.
type EnergyPlanSolarFeedInTariffV3TimeVaryingTariffs struct {
	// DisplayName Display name of the tariff.
	DisplayName string `json:"displayName"`
	...
	// Rates Array of feed in rates.
	Rates *[]EnergyPlanSolarFeedInTariffV3SingleTariffRates `json:"rates,omitempty"`

	// TimeVariations Array of time windows for which this tariff is applicable.
	TimeVariations []EnergyPlanSolarFeedInTariffV3TimeVariations `json:"timeVariations"`

	// Type The type of the charging time period. If absent applies to all periods.
	Type *EnergyPlanSolarFeedInTariffV3TimeVaryingTariffsType `json:"type,omitempty"`
}
...
// EnergyPlanTariffPeriodV2 defines model for EnergyPlanTariffPeriodV2.
type EnergyPlanTariffPeriodV2 struct {
	// BandedDailySupplyCharges Array representing banded daily supply charge rates. Mandatory if _dailySupplyChargeType_ is `BAND`.
	BandedDailySupplyCharges *[]EnergyPlanTariffPeriodV2BandedDailySupplyCharges `json:"bandedDailySupplyCharges,omitempty"`

	// DailySupplyCharge The amount of access charge for the tariff period, in dollars per day exclusive of GST. Mandatory if _dailySupplyChargeType_ is `SINGLE`.
	DailySupplyCharge *string `json:"dailySupplyCharge,omitempty"`

	// DailySupplyChargeType Specifies if daily supply charge is single or banded.
	DailySupplyChargeType *EnergyPlanTariffPeriodV2DailySupplyChargeType `json:"dailySupplyChargeType,omitempty"`

	// DemandCharges Array of demand charges. Required if _rateBlockUType_ is `demandCharges`.
	DemandCharges *[]EnergyPlanTariffPeriodV2DemandCharges `json:"demandCharges,omitempty"`
	...
	// SingleRate Object representing a single rate. Required if _rateBlockUType_ is `singleRate`.
	SingleRate *EnergyPlanTariffPeriodV2SingleRate `json:"singleRate,omitempty"`

	// StartDate The start date of the tariff period in a calendar year. Formatted in mm-dd format.
	StartDate string `json:"startDate"`

	// TimeOfUseRates Array of objects representing time of use rates that apply throughout the _tariffPeriod_. Required if _rateBlockUType_ is `timeOfUseRates`.
	TimeOfUseRates *[]EnergyPlanTariffPeriodV2TimeOfUseRates `json:"timeOfUseRates,omitempty"`
...
// EnergyPlanTariffPeriodV2DailySupplyChargeType Specifies if daily supply charge is single or banded.
...
// EnergyPlanTariffPeriodV2BandedDailySupplyCharges defines model for EnergyPlanTariffPeriodV2_bandedDailySupplyCharges.
type EnergyPlanTariffPeriodV2BandedDailySupplyCharges struct {
...
// EnergyPlanTariffPeriodV2DemandCharges defines model for EnergyPlanTariffPeriodV2_demandCharges.
type EnergyPlanTariffPeriodV2DemandCharges struct {
	...
	// EndTime End of the period. Formatted according to [ISO 8601 Times](https://en.wikipedia.org/wiki/ISO_8601#Times). If the time is provided without a UTC offset, the time zone will be determined by the value of EnergyPlanContract.timeZone.
	EndTime string `json:"endTime"`

	// MaxDemand Maximum demand for this demand tariff in kW. If present, must be higher than the value of the _minDemand_ field.
	...
	// MinDemand Minimum demand for this demand tariff in kW. If absent then `0.00` is assumed.
	MinDemand *string `json:"minDemand,omitempty"`

	// StartTime Start of the period. Formatted according to [ISO 8601 Times](https://en.wikipedia.org/wiki/ISO_8601#Times). If the time is provided without a UTC offset, the time zone will be determined by the value of EnergyPlanContract.timeZone.
...
// EnergyPlanTariffPeriodV2SingleRate Object representing a single rate. Required if _rateBlockUType_ is `singleRate`.
type EnergyPlanTariffPeriodV2SingleRate struct {
	...
	// GeneralUnitPrice The block rate (unit price) for any usage above the included fixed usage, in dollars per kWh inclusive of GST. Only required if _pricingModel_ field is `QUOTA`.
	...
	// Rates Array of rates in order of usage volume.
	Rates []EnergyPlanControlledLoadV2SingleRateRates `json:"rates"`
}

// EnergyPlanTariffPeriodV2TimeOfUse defines model for EnergyPlanTariffPeriodV2_timeOfUse.
type EnergyPlanTariffPeriodV2TimeOfUse struct {
	// Days The days that this time window applies to.
	Days []EnergyDaysEnum `json:"days"`

	// EndTime The end of the time window per day for which the rate applies. Formatted according to [ISO 8601 Times](https://en.wikipedia.org/wiki/ISO_8601#Times). If the time is provided without a UTC offset, the time zone will be determined by the value of EnergyPlanContract.timeZone.
	EndTime string `json:"endTime"`

	// StartTime The beginning of the time window per day for which the rate applies. Formatted according to [ISO 8601 Times](https://en.wikipedia.org/wiki/ISO_8601#Times). If the time is provided without a UTC offset, the time zone will be determined by the value of EnergyPlanContract.timeZone.
	StartTime string `json:"startTime"`
}

// EnergyPlanTariffPeriodV2TimeOfUseRates defines model for EnergyPlanTariffPeriodV2_timeOfUseRates.
type EnergyPlanTariffPeriodV2TimeOfUseRates struct {
	// Description Description of the rate.
	Description *string `json:"description,omitempty"`
	...
	// TimeOfUse Array of time windows for which this time of use rate applies.
	TimeOfUse []EnergyPlanTariffPeriodV2TimeOfUse `json:"timeOfUse"`
...
type EnergyUsageListResponseData struct {
	// Reads Array of meter reads sorted by NMI in ascending order followed by _readStartDate_ in descending order.
	Reads []EnergyUsageRead `json:"reads"`
}

// EnergyUsageRead defines model for EnergyUsageRead.
type EnergyUsageRead struct {
	// BasicRead Mandatory if _readUType_ is set to `basicRead`.
	BasicRead *EnergyUsageReadBasicRead `json:"basicRead,omitempty"`

	// ControlledLoad Indicates whether the energy recorded by this register is created under a Controlled Load regime.
	ControlledLoad *bool `json:"controlledLoad,omitempty"`

	// IntervalRead Mandatory if _readUType_ is set to `intervalRead`.
	...
	// ReadEndDate Date when the meter reads end in AEST. If absent then assumed to be equal to _readStartDate_. In this case the entry represents data for a single date specified by _readStartDate_.
	ReadEndDate *string `json:"readEndDate,omitempty"`

	// ReadStartDate Date when the meter reads start in AEST and assumed to start from 12:00am AEST.
...
type EnergyUsageReadIntervalRead struct {
	...
	// ReadIntervalLength Read interval length in minutes. Required when _interval-reads_ query parameter equals `FULL` or `MIN_30`.
	ReadIntervalLength *int `json:"readIntervalLength,omitempty"`

	// ReadQualities  Specifies quality of reads that are not `ACTUAL`. For read indices that are not specified, quality is assumed to be `ACTUAL`. If not present, all quality of all reads are assumed to be actual. Required when _interval-reads_ query parameter equals `FULL` or `MIN_30`.
...
// PrimaryErrorV1 defines model for PrimaryErrorV1.
type PrimaryErrorV1 struct {
	// Code The code of the error encountered. Where the error is specific to the respondent, an application-specific error code, expressed as a string value. If the error is application-specific, the URN code that the specific error extends must be provided in the _meta_ object. Otherwise, the value is the error code URN.
	Code string `json:"code"`
	...
	// IsSecondaryDataHolderError Indicates the error was propagated from a designated secondary data holder.
	IsSecondaryDataHolderError *bool `json:"isSecondaryDataHolderError,omitempty"`
...
// PrimaryErrorV1AllOf defines model for PrimaryErrorV1_allOf.
type PrimaryErrorV1AllOf struct {
	// IsSecondaryDataHolderError Indicates the error was propagated from a designated secondary data holder.
	IsSecondaryDataHolderError *bool `json:"isSecondaryDataHolderError,omitempty"`
}

// PrimaryResponseErrorListV1 defines model for PrimaryResponseErrorListV1.
type PrimaryResponseErrorListV1 struct {
	// Errors List of errors.
	Errors []PrimaryErrorV1 `json:"errors"`
}
