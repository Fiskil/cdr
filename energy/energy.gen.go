...
type EnergyBillingTransaction struct {
	...
	ExecutionDateTime time.Time `json:"executionDateTime"`
...
type EnergyServicePointDetailSpecifications struct {
	...
	NextScheduledReadDate *time.Time `json:"nextScheduledReadDate,omitempty"`
...
type ListBillingBulkParams struct {
	...
	NewestTime *time.Time `form:"newest-time,omitempty" json:"newest-time,omitempty"`
	...
	OldestTime *time.Time `form:"oldest-time,omitempty" json:"oldest-time,omitempty"`
...
type ListInvoicesBulkParams struct {
	...
	NewestDate *time.Time `form:"newest-date,omitempty" json:"newest-date,omitempty"`
	...
	OldestDate *time.Time `form:"oldest-date,omitempty" json:"oldest-date,omitempty"`
