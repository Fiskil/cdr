...
**TotalGst** | Pointer to **string** | The total GST for all electricity usage charges. If absent then zero is assumed. | [optional] [default to "0.00"]

## Methods

### NewEnergyInvoiceElectricityUsageCharges
...
### NewEnergyInvoiceElectricityUsageChargesWithDefaults
