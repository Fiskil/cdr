...
// checks if the EnergyBillingDemandTransactionV3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EnergyBillingDemandTransactionV3{}

// EnergyBillingDemandTransactionV3 struct for EnergyBillingDemandTransactionV3
...
type _EnergyBillingDemandTransactionV3 EnergyBillingDemandTransactionV3
...
func NewEnergyBillingDemandTransactionV3(timeOfUseType string, startDate string, endDate string, rate float32, amount string) *EnergyBillingDemandTransactionV3 {
	this := EnergyBillingDemandTransactionV3{}
	this.TimeOfUseType = timeOfUseType
	var isEstimate bool = false
	this.IsEstimate = &isEstimate
	this.StartDate = startDate
	this.EndDate = endDate
	var measureUnit MeasureUnitEnum = KVA
...
func (o EnergyBillingDemandTransactionV3) MarshalJSON() ([]byte, error) {
...
func (o EnergyBillingDemandTransactionV3) ToMap() (map[string]interface{}, error) {
...
func (o *EnergyBillingDemandTransactionV3) UnmarshalJSON(data []byte) (err error) {
	...
	varEnergyBillingDemandTransactionV3 := _EnergyBillingDemandTransactionV3{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEnergyBillingDemandTransactionV3)

	if err != nil {
		return err
	}

	*o = EnergyBillingDemandTransactionV3(varEnergyBillingDemandTransactionV3)

	return err
}

type NullableEnergyBillingDemandTransactionV3 struct {
	value *EnergyBillingDemandTransactionV3
	isSet bool
}

func (v NullableEnergyBillingDemandTransactionV3) Get() *EnergyBillingDemandTransactionV3 {
	return v.value
}

func (v *NullableEnergyBillingDemandTransactionV3) Set(val *EnergyBillingDemandTransactionV3) {
	v.value = val
	v.isSet = true
}

func (v NullableEnergyBillingDemandTransactionV3) IsSet() bool {
	return v.isSet
}

func (v *NullableEnergyBillingDemandTransactionV3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEnergyBillingDemandTransactionV3(val *EnergyBillingDemandTransactionV3) *NullableEnergyBillingDemandTransactionV3 {
	return &NullableEnergyBillingDemandTransactionV3{value: val, isSet: true}
}

func (v NullableEnergyBillingDemandTransactionV3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEnergyBillingDemandTransactionV3) UnmarshalJSON(src []byte) error {
	v.isSet = true
