...
type EnergyPlanControlledLoadV2 = []struct {
	...
	TimeOfUseRates *[]struct {
		...
		TimeOfUse []struct {
			...
			// EndTime The end of the time period per day for which the controlled load rate applies. Required if _startTime_ provided.
			//
			...
			// StartTime The beginning of the time period per day for which the controlled load rate applies. Required if _endTime_ provided.
			//
			// Formatted according to [ISO 8601 Times](https://en.wikipedia.org/wiki/ISO_8601#Times). If the time is provided without a UTC offset, the time zone will be determined by the value of EnergyPlanContract.timeZone.
...
type EnergyPlanSolarFeedInTariffV3 = []struct {
	...
	// TimeVaryingTariffs Represents a tariff based on time. Mandatory if _tariffUType_ is set to `timeVaryingTariffs`.
	TimeVaryingTariffs *[]struct {
		...
		TimeVariations []struct {
			...
			// EndTime The end of the time period per day for which the tariff applies. If absent assumes end of day (i.e. one second before midnight).
			//
			// Formatted according to [ISO 8601 Times](https://en.wikipedia.org/wiki/ISO_8601#Times). If the time is provided without a UTC offset, the time zone will be determined by the value of EnergyPlanContract.timeZone.
			EndTime *string `json:"endTime,omitempty"`

			// StartTime The beginning of the time period per day for which the tariff applies. If absent assumes start of day (i.e. midnight).
			//
			// Formatted according to [ISO 8601 Times](https://en.wikipedia.org/wiki/ISO_8601#Times). If the time is provided without a UTC offset, the time zone will be determined by the value of EnergyPlanContract.timeZone.
			StartTime *string `json:"startTime,omitempty"`
		} `json:"timeVariations"`
